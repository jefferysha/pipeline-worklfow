...
[English](README.md) · [使用手册](docs/usage/README.md) ·
...
[了解路由与 Workflow →](docs/usage/routing-and-workflows.md)
...
[安装、全部宿主与生命周期 →](docs/usage/installation.md)
...
[完整五分钟教程 →](docs/usage/quickstart.md)
...
[文档、Skills 与证据 →](docs/usage/documents-skills-and-evidence.md)
...
[完整宿主矩阵 →](docs/usage/installation.md#host-fidelity)
...
- [使用手册索引](docs/usage/README.md)
- [安装与宿主选择](docs/usage/installation.md)
- [快速开始](docs/usage/quickstart.md)
- [路由与 Workflows](docs/usage/routing-and-workflows.md)
- [Default Workflow 与复核](docs/usage/default-workflow.md)
- [Custom Workflows 与 Tracks](docs/usage/custom-workflows-and-tracks.md)
- [文档、Skills 与证据](docs/usage/documents-skills-and-evidence.md)
- [Dashboard 与本地 API](docs/usage/dashboard-and-local-api.md)
- [AFK 与 loop 治理](docs/usage/automation-and-loops.md)
- [高级工具](docs/usage/advanced-tools.md)
- [更新、恢复与卸载](docs/usage/updates-recovery-and-uninstall.md)
- [故障排查](docs/usage/troubleshooting.md)
- [安全模型](docs/usage/security-model.md)
- [CLI 参考](docs/usage/cli-reference.md)
- [贡献者开发](docs/usage/contributor-development.md)
