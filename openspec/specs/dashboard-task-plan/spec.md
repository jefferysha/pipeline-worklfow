# dashboard-task-plan Specification

## Purpose

定义 Dashboard 中 Project、PipelineRun、TaskPlan、TaskGroup、WorkItem、SkillInvocation、
Workflow policy 与 AFK execution 的可追溯只读治理体验，确保覆盖、依赖、状态、语言、键盘和桌面布局
均忠实消费后端权威数据。
