  ...
  if (kind === 'no-change') {
    ...
    return (
      <div className={`${EMPTY_CLS} max-w-[460px]`} data-testid="onboard-no-change">
        ...
        <button
          type="button"
          className="mb-4 inline-flex items-center justify-center rounded-lg bg-btn-bg px-4 py-2 text-xs font-bold text-btn-fg transition-colors hover:bg-btn-hover focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--accent) motion-reduce:transition-none"
