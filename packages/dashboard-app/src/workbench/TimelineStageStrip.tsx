...
export function TimelineStageStrip({
  ...
  return (
    <div>
      <p
        id={scrollHintId}
        data-testid="wb-stage-scroll-hint"
        className="mb-1.5 ms-auto hidden w-max items-center gap-1.5 rounded-full border border-border bg-fill px-2.5 py-1 text-xs font-medium text-text-3 max-[1180px]:inline-flex"
      >
        <ArrowLeftRight className="h-3.5 w-3.5" aria-hidden="true" />
        {t('workbench.stage_scroll_hint')}
      </p>
      <section
