...
const PURPOSES: Record<string, { name: string; description: string }> = {
  ...
  'pipeline-open': { name: '启动变更', description: '建立变更上下文并明确本轮目标与边界。' },
  'pipeline-explore': { name: '探索方案', description: '调研现状与约束，为后续规格提供依据。' },
  'pipeline-build': { name: '实施变更', description: '按照已确认规格完成代码与配置修改。' },
  'pipeline-verify': { name: '验证变更', description: '运行真实检查并整理可复核的验证结论。' },
  'pipeline-ship': { name: '交付变更', description: '整理交付内容并完成发布前后的必要动作。' },
  'pipeline-archive': { name: '归档变更', description: '保存最终状态、证据与可追溯记录。' },
  'pipeline-spec': { name: '编写规格', description: '把需求整理成可实施、可验收的明确规格。' },
  'pipeline-lite': { name: 'Pipeline Lite 操作', description: '操作当前项目的工作流、阶段与状态事实。' },
  ...
  'pipeline-researcher': { name: '并行专题调研', description: '按专题独立收集资料并输出可合并的研究结论。' },
