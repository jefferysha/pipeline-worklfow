        ...
        {variant === 'workspace' ? (
          <>
            <header className="flex min-h-16 flex-none items-center gap-4 border-b border-border bg-card px-6">
              ...
              <button type="button" className="grid size-10 place-items-center rounded-full text-text-3 transition hover:bg-fill hover:text-text" aria-label="关闭" onClick={onClose}><X className="size-4" strokeWidth={1.75} aria-hidden="true" /></button>
            </header>
