...
export const zh: Dict = {
  ...
  workbench: {
    ...
    editor_placeholder: '「{name}」的详细配置（基本信息 / 技能 / 钩子 / 产出物）将在这里展开——编辑功能尚未开放。',
    summary_title: '摘要',
    sum_stages: '阶段',
    sum_gates: '复核门',
    sum_skills: '技能',
...
export const en: Dict = {
  ...
  workbench: {
    ...
    editor_placeholder: 'The detailed configuration of "{name}" (basics / skills / hooks / outputs) will expand here — editing is not available yet.',
    summary_title: 'Summary',
    sum_stages: 'Stages',
